...
(defvar color-theme-sanityinc-solarized--color-space 'sRGB)

(defvar color-theme-sanityinc-solarized--colors
  ;; The RGB values are the Generic RGB equivalents of the "official" sRGB hex values
  '((base03  (RGB . "#042028") (sRGB . "#002b36"))
    (base02  (RGB . "#0a2832") (sRGB . "#073642"))
    (base01  (RGB . "#465a61") (sRGB . "#586e75"))
    (base00  (RGB . "#52676f") (sRGB . "#657b83"))
    (base0   (RGB . "#708183") (sRGB . "#839496"))
    (base1   (RGB . "#81908f") (sRGB . "#93a1a1"))
    (base2   (RGB . "#e9e2cb") (sRGB . "#eee8d5"))
    (base3   (RGB . "#fcf4dc") (sRGB . "#fdf6e3"))
    (yellow  (RGB . "#a57705") (sRGB . "#b58900"))
    (orange  (RGB . "#bd3612") (sRGB . "#cb4b16"))
    (red     (RGB . "#c60007") (sRGB . "#dc322f"))
    (magenta (RGB . "#c61b6e") (sRGB . "#d33682"))
    (violet  (RGB . "#5859b7") (sRGB . "#6c71c4"))
    (blue    (RGB . "#2075c7") (sRGB . "#268bd2"))
    (cyan    (RGB . "#259185") (sRGB . "#2aa198"))
    (green   (RGB . "#728a05") (sRGB . "#859900"))))
...
`MODE' should be set to either 'light or 'dark."
  (labels ((color (name)
		  (cdr (assoc color-theme-sanityinc-solarized--color-space
			      (assoc name color-theme-sanityinc-solarized--colors)))))
    `(let* ((base03  ,(color 'base03))
	    (base02  ,(color 'base02))
	    (base01  ,(color 'base01))
	    (base00  ,(color 'base00))
	    (base0   ,(color 'base0))
